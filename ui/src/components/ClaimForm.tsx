          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                type="text"
                required
                value={form.claimant.full_name}
                onChange={(e) => handleChange('claimant', 'full_name', e.target.value)}
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                id="email"
                type="email"
                value={form.claimant.email || ''}
                onChange={(e) => handleChange('claimant', 'email', e.target.value || undefined)}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange('claimant', 'address', e.target.value || undefined)}
        ...
        <section className="claim-form-section">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input
                id="city"
                type="text"
                value={form.loss.city || ''}
                onChange={(e) => handleChange('loss', 'city', e.target.value || undefined)}
          ...
          <div className="form-group">
            ...
            <textarea
              id="description"
              rows={4}
              value={form.loss.description}
              onChange={(e) => handleChange('loss', 'description', e.target.value)}
        ...
        <section className="claim-form-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleChange('vehicle', 'vin', e.target.value || undefined)}
          ...
          <div className="form-row form-row-3">
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange('vehicle', 'year', e.target.value ? Number(e.target.value) : undefined)
                }
                placeholder="2020"
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange('vehicle', 'make', e.target.value || undefined)}
                placeholder="Honda"
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleChange('vehicle', 'model', e.target.value || undefined)}
                placeholder="Civic"
              />
            </div>
          </div>
